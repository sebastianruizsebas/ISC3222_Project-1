...
params.T_per_trial = 2.5;      % seconds per trial
params.n_trials = 1;           % number of different trajectories
...
params.vmax_ball = 3.0;                 % max allowed initial ball speed (m/s)
params.min_start_sep = 1;             % minimum separation between player and ball start (m)
